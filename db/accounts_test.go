...
func TestClient_UpdateAccountLastSynced(t *testing.T) {
	ctx := context.Background()
	id := "test-account-id"
	...
	err := client.UpdateAccountLastSynced(ctx, id)
	if err != nil {
		t.Fatalf("UpdateAccountLastSynced failed: %v", err)
	}
}

func TestClient_UpdateAccountLastSynced_NotFound(t *testing.T) {
	ctx := context.Background()
	...
	err := client.UpdateAccountLastSynced(ctx, "non-existent-id")
	if err == nil {
		t.Fatal("Expected error for non-existent account")
	}
	if !errors.Is(err, ErrNotFound) {
...
func TestClient_UpdateAccountLabel(t *testing.T) {
	ctx := context.Background()
	id := "test-account-id"
	label := "arb"
	...
	if err := client.UpdateAccountLabel(ctx, id, label); err != nil {
		t.Fatalf("UpdateAccountLabel failed: %v", err)
	}
}

func TestClient_UpdateAccountLabel_NotFound(t *testing.T) {
	ctx := context.Background()
	...
	err := client.UpdateAccountLabel(ctx, "non-existent-id", "some-label")
	if err == nil {
		t.Fatal("Expected error for non-existent account")
	}
	if !errors.Is(err, ErrNotFound) {
